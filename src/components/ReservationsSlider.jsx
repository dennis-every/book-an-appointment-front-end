        ...
        <div className="place-list-container">
          ...
          <div className="pagination">
            ...
            >
              ...
              >
                <Icon color="#fff" icon="bx:left-arrow" aria-label="Previous" />
              </button>
            </div>
            <div
              className={`button-boxright ${
                reservationsItems.length <= (currentPage + 1) * 3
                  ? 'disabled'
                  : ''
              }`}
            >
              <button
                ...
                onClick={showNext}
              >
                <Icon color="#fff" icon="bx:right-arrow" aria-label="Next" />
              </button>
            </div>
          </div>
        </div>
